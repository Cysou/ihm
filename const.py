...
dico_gates = {}
dico_gates["gate_or"] = (5, 3, "or")
dico_gates["gate_and"] = (5, 3, "and")
dico_gates["gate_not"] = (5, 3, "not")
dico_gates["gate_xor"] = (5, 3, "xor")

# grid.py
grid_width = 900    # Il faut que grid_width % grid_squares = 0
grid_height = 520   # Il faut que grid_height % grid_squares = 0
grid_squares = 10
